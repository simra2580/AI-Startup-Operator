        ...
        <Card className="p-10">
          <div className="text-center mb-10">
            ...
            <p className="text-white/60">
              {isLogin ? "Sign in to your account" : "Join 10K+ founders building with AI"}
            </p>
          </div>
            ...
            {!isLogin && (
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full px-4 py-4 bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-purple-500 transition-all"
  ...
  >
    ...
    <span>User</span>
          ...
          <div className="mt-8 pt-8 border-t border-white/10 text-center">
            <Link to="/" className="text-white/60 hover:text-white transition-colors inline-flex items-center space-x-2">
