...
var SpeechToTextV1 = /** @class */ (function (_super) {
     ...
     */
    SpeechToTextV1.prototype.detectLanguage = function (params) {
        var _params = __assign({}, params);
        var _requiredParams = ['lidConfidence', 'audio'];
        var _validParams = ['lidConfidence', 'audio', 'contentType', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
        ...
        var sdkHeaders = (0, common_1.getSdkHeaders)(SpeechToTextV1.DEFAULT_SERVICE_NAME, 'v1', 'detectLanguage');
        var parameters = {
            options: {
...
(function (SpeechToTextV1) {
    ...
    var DetectLanguageConstants;
    (function (DetectLanguageConstants) {
        ...
        (function (ContentType) {
            ...
            ContentType["AUDIO_WEBM_CODECS_OPUS"] = "audio/webm;codecs=opus";
            ContentType["AUDIO_WEBM_CODECS_VORBIS"] = "audio/webm;codecs=vorbis";
        })(ContentType = DetectLanguageConstants.ContentType || (DetectLanguageConstants.ContentType = {}));
    })(DetectLanguageConstants = SpeechToTextV1.DetectLanguageConstants || (SpeechToTextV1.DetectLanguageConstants = {}));
    var AcousticModel;
