...
var AssistantV2 = /** @class */ (function (_super) {
    ...
    AssistantV2.prototype.createSession = function (params) {
        ...
        var _validParams = ['assistantId', 'environmentId', 'analytics', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    AssistantV2.prototype.deleteSession = function (params) {
        ...
        var _validParams = ['assistantId', 'environmentId', 'sessionId', 'signal', 'headers'];
        var _validationErrors = (0, ibm_cloud_sdk_core_1.validateParams)(_params, _requiredParams, _validParams);
        if (_validationErrors) {
            return Promise.reject(_validationErrors);
        }
    ...
    (function (DtmfCommandInfo) {
        ...
        (function (Constants) {
            ...
            (function (Type) {
                ...
                Type["DISABLE_BARGE_IN"] = "disable_barge_in";
                Type["ENABLE_BARGE_IN"] = "enable_barge_in";
                Type["SEND"] = "send";
            })(Type = Constants.Type || (Constants.Type = {}));
        })(Constants = DtmfCommandInfo.Constants || (DtmfCommandInfo.Constants = {}));
    })(DtmfCommandInfo = AssistantV2.DtmfCommandInfo || (AssistantV2.DtmfCommandInfo = {}));
